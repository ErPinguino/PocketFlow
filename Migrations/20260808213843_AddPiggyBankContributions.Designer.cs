...
namespace PocketFlow.Migrations
{
    ...
    [Migration("20260808213843_AddPiggyBankContributions")]
    partial class AddPiggyBankContributions
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PocketFlow.Models.PiggyBankContribution", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("PiggyBankId", "MonthlyPlanId", "Type");

                    b.ToTable("PiggyBankContributions", t =>
                        {
                            t.HasCheckConstraint("CK_PiggyBankContribution_Amount", "\"Amount\" > 0");
                        });
                });
